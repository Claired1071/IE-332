...
<body>
	...
	if(mysqli_num_rows($check) > 0){
		...
		$sql = "INSERT INTO Student (Email, Password, Fname, Lname, Pnumber, Major, GPA, Courses, Year)
		VALUES('" . $s_email . "', '" . $s_password . "', '" . $s_fname . "', '" . $s_lname . "', '" . $s_number . "', '" . $s_major . "', '" . $stud_GPA . "', '" . $stud_courses . "', '" . $stud_year . "')";
